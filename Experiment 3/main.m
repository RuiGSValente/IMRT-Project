...
%SA~N(0, 90^2) -> simulated_annealing(f, n_theta, 1);
%ASA~N(0, 90^2) -> simulated_annealing(f, n_theta, 2);
%ASA~N(0, 45^2) -> simulated_annealing(f, n_theta, 3);
%ASA~U(-90, 90) -> simulated_annealing(f, n_theta, 4);

%SASD~N(0, 90^2) ->  adapted_simulated_annealing(f, n_theta, 1);
%ASASD~N(0, 90^2) ->  adapted_simulated_annealing(f, n_theta, 2);
%ASASD~N(0, 45^2) ->  adapted_simulated_annealing(f, n_theta, 3);
%ASASD~U(-90, 90) ->  adapted_simulated_annealing(f, n_theta, 4);

%HM~N(0, 90^2) -> hybrid_method(f, n_theta, 1);
%AHM~N(0, 90^2) -> hybrid_method(f, n_theta, 2);
%AHM~N(0, 45^2) -> hybrid_method(f, n_theta, 3);
%AHM~U(-90, 90) -> hybrid_method(f, n_theta, 4);


[result, time, theta] = simulated_annealing(f, n_theta, 1);
